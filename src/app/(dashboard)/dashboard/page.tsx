    ...
    <div className="max-w-6xl mx-auto">
          ...
          return (
            <div key={i} className="rounded-xl glass-card p-6">
              <div className="mb-4 flex items-center justify-between">
                ...
                <div
                  className={`flex h-10 w-10 items-center justify-center rounded-lg ${style.container}`}
                >
                  <svg
        ...
        <div className="mb-8 rounded-xl glass-card p-6">
          <div className="mb-4 flex items-center justify-between">
            ...
            <button
              ...
              aria-label="Close CV upload panel"
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <div className="rounded-xl glass-card p-6 card-hover">
          <div
            className={`h-12 w-12 rounded-xl bg-emerald-500/20 flex items-center justify-center mb-4`}
          >
            <svg
          ...
          <button
            ...
            aria-label={
              showUpload ? "Hide CV upload form" : "Show CV upload form"
            }
        ...
        <div className="rounded-xl glass-card p-6 card-hover">
          ...
          <Link
            href="/jobs"
            className="mt-4 inline-block rounded-lg border border-emerald-500/50 px-4 py-2 text-sm font-medium text-emerald-400 hover:bg-emerald-500/10 transition-all"
          >
            Browse Jobs
          </Link>
        </div>
        ...
        <div className="rounded-xl glass-card p-6 card-hover">
          ...
          <Link
            href="/interview"
            className="mt-4 inline-block rounded-lg border border-purple-500/50 px-4 py-2 text-sm font-medium text-purple-400 hover:bg-purple-500/10 transition-all"
          >
            Start Practice
          </Link>
        </div>
