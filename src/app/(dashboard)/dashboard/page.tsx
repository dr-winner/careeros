    ...
    <div className="mx-auto max-w-7xl px-6 py-8">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <div className="rounded-2xl border border-emerald-100 bg-white p-6">
          ...
          <Link href="/jobs" className="mt-4 inline-block rounded-lg border border-emerald-800 px-4 py-2 text-sm font-medium text-emerald-800 hover:bg-emerald-50">
            Browse Jobs
          </Link>
        </div>
        ...
        <div className="rounded-2xl border border-emerald-100 bg-white p-6">
          ...
          <Link href="/interview" className="mt-4 inline-block rounded-lg border border-emerald-800 px-4 py-2 text-sm font-medium text-emerald-800 hover:bg-emerald-50">
            Start Practice
          </Link>
        </div>
      </div>
