    ...
    <div className="mx-auto max-w-2xl px-6 py-8">
      ...
      <div className="space-y-6">
        <div className="rounded-xl border border-emerald-100 bg-white p-6">
          <h2 className="mb-4 text-lg font-semibold text-emerald-950">Account</h2>
          <div className="space-y-4">
            <div>
              <label className="mb-1 block text-sm font-medium text-emerald-700">Email</label>
              <input
                type="email"
                value={profile?.email || user?.primaryEmailAddress?.emailAddress || ""}
                disabled
                className="w-full rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-2 text-emerald-600"
              />
              <p className="mt-1 text-xs text-emerald-500">Email cannot be changed</p>
            </div>
            <div>
              <label className="mb-1 block text-sm font-medium text-emerald-700">Full Name</label>
              <input
                type="text"
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-emerald-700">Phone Number</label>
              <input
                type="tel"
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-emerald-700">Country</label>
              <select
        ...
        <div className="rounded-xl border border-emerald-100 bg-white p-6">
          <h2 className="mb-4 text-lg font-semibold text-emerald-950">Professional Info</h2>
          <div className="space-y-4">
            <div>
              <label className="mb-1 block text-sm font-medium text-emerald-700">Professional Headline</label>
              <input
                type="text"
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-emerald-700">Role Type</label>
              <select
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-emerald-700">Experience Level</label>
              <select
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-emerald-700">Desired Role</label>
              <input
                type="text"
